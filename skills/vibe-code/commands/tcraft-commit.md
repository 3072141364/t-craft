...
触发 `traft-code-git` 的「扫描代码变更」流程,按 `references/commit-rules.md` 出候选。
...
2. 按意图分组,每候选只做一件事(feat / fix / docs / refactor / ...),参考 `skill://traft-code-git/references/commit-rules.md` 选 type + emoji + scope + subject(祈使句、一行说清)。
