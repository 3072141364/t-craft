...
## 执行
读 `skill://traft-code-git`,按「切换分支」流程走:
...
3. `git branch -a` 列本地/远程分支,结合 `skill://traft-code-git/references/branch-rules.md` 的命名规则产出 3-5 个候选名(每个附一句说明)。
