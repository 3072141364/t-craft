...
> traft-code-git 的附属文档:git 操作命令参考。拉取/推送/同步代码、切分支、撤销、stash、rebase、冲突解决等场景读本文。分支命名与提交规范分别见 [branch-rules.md](branch-rules.md) 与 [commit-rules.md](commit-rules.md),此处只列命令。
